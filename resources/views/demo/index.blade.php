		...
		<div class="row">
			<div class="col-lg-6 right-border-grey">
				<div class="bottom20">
					...
					<form method="POST" accept-charset="UTF-8" id="listenForm" class="form form-inline">
						<!-- listen_event_name Field -->
						<div class="form-group">
							<label for="listen_event_name" class="control-label">Event: </label>
							<input class="form-control" name="listen_event_name" type="text" id="listen_event_name">
						</div>
						<!-- Submit Button -->
						<div class="form-group">
			...
			<div class="col-lg-6 left-border-grey">
				...
				<form id="requestForm" class="form-horizontal" method="POST" accept-charset="UTF-8">
				
					<!-- Channel Field -->
					<div class="form-group">
						<label for="channel" class="control-label col-sm-2">Channel</label>
						<div class="col-sm-10">
					...
					<!-- event Field -->
					<div class="form-group">
					    <label for="event" class="control-label col-sm-2">Event</label>
						<div class="col-sm-10">
							<input class="form-control" placeholder="event_name" name="event" type="text" id="event">
						</div>
					</div>

					<!-- payload Field -->
					<div class="form-group">
						<label for="payload" class="control-label col-sm-2">Payload</label>
						<div class="col-sm-10">
							<textarea rows="3" class="form-control" name="payload" cols="50" id="payload">{
&nbsp;&nbsp;&nbsp;&nbsp;"foo": "bar"
}</textarea>
						</div>
					</div>
...
function connect() {
	...
	conn = new ab.Session('ws://pushman.dfl.mn:8080?token=zjVHWGbiI2fQjo1A2AQK',
		function() {
